 ...
 * Loop count                        AL_LOOP_COUNT           ALuint
 ...
 * State Callback                    AL_SOURCE_STATE_CALLBACK      LPALSOURCESTATECB
 * State Callback user data          AL_SOURCE_STATE_CALLBACK_DATA ALviod*
 */
...
AL_API void AL_APIENTRY alSourceu( ALuint sid, ALenum param, ALuint value );
...
typedef void           (AL_APIENTRY *LPALSOURCEU)( ALuint sid, ALenum param, ALuint value);
